...
const USMap = () => {
  ...
  useEffect(() => {
    // Dynamically import the GeoJSON file on the client
    import('../../public/us-states.geojson')
      .then((data) => {
        console.log("GeoJSON loaded:", data); // Check if data loads correctly
        setUsStates(data.default || data);
      })
